...
function cpuPlayer() {
    ...
    let ableYahtzee = document.getElementById('yahtzee' + playerId).hasAttribute('disabled') ? false : true;
    let ableLargeStraight = document.getElementById('largeStraight' + playerId).hasAttribute('disabled') ? false : true;
    let ableSmallStraight = document.getElementById('smallStraight' + playerId).hasAttribute('disabled') ? false : true;
    let ableFullHouse = document.getElementById('fullHouse' + playerId).hasAttribute('disabled') ? false : true;
    let ableSixes = document.getElementById('sixes' + playerId).hasAttribute('disabled') ? false : true;
    let ableFives = document.getElementById('fives' + playerId).hasAttribute('disabled') ? false : true;
    let ableFours = document.getElementById('fours' + playerId).hasAttribute('disabled') ? false : true;
    let ableFourOfKind = document.getElementById('fourOfKind' + playerId).hasAttribute('disabled') ? false : true;
    let ableThreeOfKind = document.getElementById('threeOfKind' + playerId).hasAttribute('disabled') ? false : true;
    let ableThrees = document.getElementById('threes' + playerId).hasAttribute('disabled') ? false : true;
    let ableTwos = document.getElementById('twos' + playerId).hasAttribute('disabled') ? false : true;
    let ableAces = document.getElementById('aces' + playerId).hasAttribute('disabled') ? false : true;
    let ableChance = document.getElementById('chance' + playerId).hasAttribute('disabled') ? false : true;
    ...
    function isFourOfKind() { // add yahtzee ? || tempNumber.length === 6 
        for (i = 1; i <= 6; i++) {
            let tempNumber = turnScore.filter(point => point === i);
            if (tempNumber.length === 4 || tempNumber.length === 5) {
                return true;
    ...
    function istTreeOfKind() { // add yahtzee ? || tempNumber.length === 6
        for (i = 1; i <= 6; i++) {
            let tempNumber = turnScore.filter(point => point === i);
            if (tempNumber.length === 3 || tempNumber.length === 4 || tempNumber.length === 5) {
                return true;
